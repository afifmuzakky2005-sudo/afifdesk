...
class MyTheme {
  ...
  static const Color idColor = Color(0xFFFF8800);
  static const Color darkGray = Color.fromARGB(255, 148, 148, 148);
  static const Color cmIdColor = Color(0xFF21790B);
  static const Color dark = Colors.black87;
  static const Color button = Color(0xFFFF7200);
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.light(
        primary: Colors.orange, secondary: accent, background: grayBg),
...
String _appName = 'AfifDesk';
String get appName {
  if (_appName.isEmpty || _appName == 'RustDesk') {
    final name = bind.mainGetAppNameSync();
    if (name.isNotEmpty && name != 'RustDesk') {
      _appName = name;
    } else {
      _appName = 'AfifDesk';
    }
